...
In the following sections you can find detailed explanations of PyTorch
Android API, code walk through for a bigger `demo
application <https://github.com/pytorch/android-demo-app/tree/master/PyTorchDemoApp>`__,
...
`Image
Segmentation <https://github.com/pytorch/android-demo-app/tree/master/ImageSegmentation>`__
...
model and an Android app that uses the model to segment images.

Object Detection
~~~~~~~~~~~~~~~~

`Object
Detection <https://github.com/pytorch/android-demo-app/tree/master/ObjectDetection>`__
...
`Speech
Recognition <https://github.com/pytorch/android-demo-app/tree/master/SpeechRecognition>`__
...
scripted model in an Android app to perform speech recognition.
...
`Image Segmentation DeepLabV3 on Android <https://pytorch.org/tutorials/beginner/deeplabv3_on_android.html>`__
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

A comprehensive step-by-step tutorial on how to prepare and run the
PyTorch DeepLabV3 image segmentation model on Android.
...
`Making Android Native Application That Uses PyTorch Android Prebuilt Libraries <https://pytorch.org/tutorials/recipes/android_native_app_with_custom_op.html>`__
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Learn how to make Android application from the scratch that uses
LibTorch C++ API and uses TorchScript model with custom C++ operator.
...
`Model Preparation for Android Recipe <https://pytorch.org/tutorials/recipes/model_preparation_android.html>`__
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Learn how to add the model in an Android project and use the PyTorch
library for Android.
...
Watch the following `video <https://youtu.be/5Lxuu16_28o>`__ as PyTorch
Partner Engineer Brad Heintz walks through steps for setting up the
PyTorch Runtime for Android projects:

`|PyTorch Mobile Runtime for Android|\ {:height=“75%”
width=“75%”} <https://youtu.be/5Lxuu16_28o>`__

The corresponding code can be found
`here <https://github.com/pytorch/workshops/tree/master/PTMobileWalkthruAndroid>`__.

Checkout our `Mobile Performance
...
In addition, follow this recipe to learn how to `make Native Android
Application that use PyTorch prebuilt
libraries <https://pytorch.org/tutorials/recipes/android_native_app_with_custom_op.html>`__.

API Docs
--------

You can find more details about the PyTorch Android API in the
`Javadoc <https://pytorch.org/javadoc/>`__.
...
.. |PyTorch Mobile Runtime for Android| image:: https://i.ytimg.com/vi/O_2KBhkIvnc/maxresdefault.jpg
